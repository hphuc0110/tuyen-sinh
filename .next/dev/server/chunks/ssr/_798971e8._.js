...
;
;
const LearningPathSection = ({ svgHeight = "auto", svgMinHeight = "200px", svgMaxHeight = "none", svgWidth = "100%", svgMinWidth = "auto", svgMaxWidth = "none", svgAspectRatio = "3000/342", containerClassName = "", fullWidth = true } = {})=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const loadSVG = ()=>{
            if (ref.current?.contentDocument) {
                ...
                // Tìm các path với class path1, path2, path3, path4 trong SVG document
                const path1 = svgDoc.querySelector(".path1");
                const path2 = svgDoc.querySelector(".path2");
                const path3 = svgDoc.querySelector(".path3");
                const path4 = svgDoc.querySelector(".path4");
        ...
        // Load SVG when object is ready
        if (ref.current) {
            ref.current.addEventListener("load", loadSVG);
            // Also try immediately in case it's already loaded
            loadSVG();
        }
        return ()=>{
            if (ref.current) {
                ref.current.removeEventListener("load", loadSVG);
            }
            if (cleanup) {
                cleanup();
            }
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["motion"].div, {
                        ...
                        style: {
                            ...
                            width: fullWidth ? undefined : svgWidth,
...
//# sourceMappingURL=_798971e8._.js.map