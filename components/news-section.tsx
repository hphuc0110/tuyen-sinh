...
const newsList = [
  {
    ...
    contentDetail:
      "Dự án AI57 do Đại Học Bách Khoa Hà Nội, NVIDIA và Hồng Lĩnh phối hợp triển khai học bổng AI từ 11/2025, nhằm phát hiện, bồi dưỡng tài năng trẻ và xây dựng nguồn nhân lực trí tuệ nhân tạo cho Việt Nam.",
    image: kysuai.src,
